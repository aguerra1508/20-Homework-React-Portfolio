...
<h2 className="card-title">About Me:</h2>
  <div className="card-body">
	<img src="https://media-exp1.licdn.com/dms/image/C4E03AQHsugInc3qX3w/profile-displayphoto-shrink_400_400/0?e=1609977600&v=beta&t=mzXR650hBBKSPTIefn1dRUr3EC9re0PZK3p9B4CKPGQ" className="imgindex" alt="Analee Guerra"></img>
		...
		Medical Laboratory Scientist at University Hospital in San Antonio, Texas. In my spare time, 
		I love going hunting, fishing and being in the outdoors. Health and fitness are also passions
		...
		<ul className="contact-list">
						...
						<p>
						<i class="far fa-file"></i> Resume: <a href={Resume} target="_blank">Analee Guerra</a>
						</p>
						<p>
